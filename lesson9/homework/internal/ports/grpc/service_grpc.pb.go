...
func (c *adServiceClient) ListAds(ctx context.Context, in *Mode, opts ...grpc.CallOption) (*ListAdResponse, error) {
...
func (UnimplementedAdServiceServer) ListAds(context.Context, *Mode) (*ListAdResponse, error) {
